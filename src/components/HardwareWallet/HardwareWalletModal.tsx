...
export const HardwareWalletModal: React.FC<HardwareWalletModalProps> = ({
    ...
    const [selectedDevice, setSelectedDevice] = useState<
        "ledger" | "trezor" | null
    >(null);
    const [selectedAccountLocal, setSelectedAccountLocal] =
    ...
    const renderConnectionSteps = () => {
        const steps = {
            detecting: {
                ...
                message:
                    "Please make sure your hardware wallet is connected and unlocked.",
            },
            connecting: {
                title: "Connecting",
            ...
            <AccountsList>
                {accounts.map((account) => (
                    <AccountItem
                        key={account.address}
                        isSelected={
                            selectedAccountLocal?.address === account.address
                        }
