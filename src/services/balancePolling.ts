...
// 
//         console.info(
//             `[Balance Polling] Starting poll for ${accounts.length} accounts on ${selectedNetwork.name}...`,
//         );
// 
//         try {
...
//                         const oldBalance =
//                             previousBalances.get(account.id) || "0";
// 
...
//                 } catch (error) {
//                     console.error(
//                         `[Balance Polling] Failed for account ${account.name}:`,
//                         error,
//                     );
//                 }
//             }
...
//             lastPoll.getTime() + config.intervalMinutes * 60 * 1000,
//         );
//         const now = new Date();
