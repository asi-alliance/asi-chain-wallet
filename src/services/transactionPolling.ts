//TODO: Disabled during SDK migration. Legacy RChain polling replaced by the SDK DeployStatusPoller (see sendTransaction thunk) and periodic fetchTransactionHistory. Restore/remove once fully validated.
...
//         if (this.isPolling) {
//             console.info(
//                 "[Transaction Polling] Already polling, skipping start",
//             );
//             return;
//         }
// 
//         console.info(
//             "[Transaction Polling] Starting transaction status polling...",
//         );
//         this.isPolling = true;
// 
...
//         console.info(
//             "[Transaction Polling] Stopped transaction status polling",
//         );
//     }
// 
...
//                     this.corsErrorCount++;
//                     console.warn(
//                         `[Transaction Polling] GraphQL API not accessible due to CORS/network issues. Error count: ${this.corsErrorCount}/${this.MAX_CORS_ERRORS}`,
//                     );
// 
//                     if (this.corsErrorCount >= this.MAX_CORS_ERRORS) {
//                         console.warn(
//                             "[Transaction Polling] Too many CORS errors. Temporarily disabling polling.",
//                         );
//                         this.stop();
//                         return;
//                     }
...
//                 (tx.to &&
//                     account.revAddress.toLowerCase() === tx.to.toLowerCase()),
//         );
// 
//         for (const account of affectedAccounts) {
//             try {
//                 console.info(
//                     `[Transaction Polling] Refreshing balance for ${account.name}...`,
//                 );
//                 const oldBalance = account.balance || "0";
// 
//                 const balanceResult = await store.dispatch(
//                     fetchBalance({
...
//                         console.info(
//                             `[Transaction Polling] Balance increased for ${account.name}, checking for received transactions...`,
//                         );
//                         try {
...
//                         } catch (error) {
//                             console.error(
//                                 `[Transaction Polling] Error detecting received transaction for ${account.name}:`,
//                                 error,
//                             );
//                         }
//                     }
...
//             } catch (error) {
//                 console.error(
//                     `[Transaction Polling] Error refreshing balance for ${account.name}:`,
//                     error,
//                 );
//             }
//         }
...
//         console.info(
//             "[Transaction Polling] Force checking pending transactions...",
//         );
//         this.pollPendingTransactions();
//     }
// 
...
//         try {
//             const pendingTxsJson = localStorage.getItem(
//                 "asi_wallet_pending_transactions",
//             );
//             if (!pendingTxsJson) {
//                 return;
//             }
...
// 
//             console.info(
//                 `[Transaction Polling] Checking ${pendingTxs.length} pending transactions...`,
//             );
...
//                     console.warn(
//                         `[Transaction Polling] ⚠️ Deploy ${tx.deployId} is ${ageHours.toFixed(1)} hours old. Likely never reached the server. Removing from pending.`,
//                     );
//                     hasUpdates = true;
//                     continue;
//                 }
...
//                         console.info(
//                             `[Transaction Polling] ✅ Deploy ${tx.deployId} completed!`,
//                         );
//                         hasUpdates = true;
//                         continue;
//                     } else if (result.status === "errored") {
//                         console.error(
//                             `[Transaction Polling] ❌ Deploy ${tx.deployId} errored: ${result.error}`,
//                         );
//                         hasUpdates = true;
//                         continue;
//                     } else {
...
//                 } catch (error: any) {
//                     console.warn(
//                         `[Transaction Polling] Error checking deploy ${tx.deployId}:`,
//                         error.message,
//                     );
//                     updatedTxs.push(tx);
//                 }
...
//                 );
//                 console.info(
//                     `[Transaction Polling] Updated pending transactions. Remaining: ${updatedTxs.length}`,
//                 );
// 
...
//                         } catch (error) {
//                             console.error(
//                                 `[Transaction Polling] Error refreshing balance:`,
//                                 error,
//                             );
//                         }
//                     }
...
//         } catch (error) {
//             console.error(
//                 "[Transaction Polling] Error checking pending deploys:",
//                 error,
//             );
//         }
//     }
